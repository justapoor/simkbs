        ...
        <tbody>
            ...
            <tr>
                <td colspan="3" valign="top" align="justify">
                    <span style="font-size:17px">
                        <br>
                        Yang bertanda tangan dibawah ini Kepala Desa Bayun Sari Kecamatan Sungai Laur Kabupaten
                        Ketapang, Dengan ini menyatakan bahwa:
                    </span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3" valign="top">
                    <div align="justify">
                        <span style="font-size:17px">
                            ...
                            Adalah benar yang bersangkutan tersebut diatas merupakan penduduk Desa Cikampek yang saat
                            ini mempunyai:
                        </span>
                    </div>
                </td>
            ...
            <tr>
                <td colspan="3" valign="top">
                    <div align="justify">
                        <span style="font-size:17px">
                            <br>
                            Demikianlah Surat Keterangan Usaha ini dibuat dan diberikan kepada yang bersangkutan agar
